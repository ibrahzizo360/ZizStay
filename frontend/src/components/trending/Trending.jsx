  ...
  return (
    <div className='trending'>
        ...
        <div className="trendingItem"  onClick={() => handleClick("London")}>
            <img className="trendingImg" src="https://fullsuitcase.com/wp-content/uploads/2021/11/Where-to-stay-in-London-best-areas-for-first-time-sightseeing-families-luxury-and-more.jpg" alt="London" />
            <div className="trendingTitles">
                <h1>London</h1>
        ...
        <div className="trendingItem"  onClick={() => handleClick("Johannesburg")}>
            <img className="trendingImg" src="https://media.cntraveller.com/photos/611be87ef6bd8f17556dab7c/4:3/w_1704,h_1278,c_limit/view-of-city-centre-from-ansteys-building-johannesburg-conde-nast-traveller-27jan15-david-crookes.jpg" alt="Johannesburg" />
            <div className="trendingTitles">
                <h1>Johannesburg</h1>
        ...
        <div className="trendingItem" onClick={() => handleClick("Dubai")}>
            <img className="trendingImg" src="https://cdn.siasat.com/wp-content/uploads/2023/06/Dubai-1.jpg" alt="Dubai" />
            <div className="trendingTitles">
                <h1>Dubai</h1>
